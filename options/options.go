...
type Options struct {
	...
	AliveRate         int    `short:"a" long:"alive-rate" description:"The rate of alive cells in initialization" default:"50"`
	MutRate           int    `short:"m" long:"mut-rate" description:"The rate of mutation" default:"1"`
